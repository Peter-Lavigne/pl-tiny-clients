...
class Settings(BaseSettings):
    ...
    spotify_client_id: str = Field(validation_alias="SPOTIFY_CLIENT_ID", default="")
    ...
    spotify_desktop_device_name: str = Field(
        validation_alias="SPOTIFY_DESKTOP_DEVICE_NAME", default=""
    )
    spotify_phone_device_name: str = Field(
        validation_alias="SPOTIFY_PHONE_DEVICE_NAME", default=""
    )
    trello_api_key: str = Field(validation_alias="TRELLO_API_KEY", default="")
    trello_token: str = Field(validation_alias="TRELLO_TOKEN", default="")
    trello_planning_board_id: str = Field(
        validation_alias="TRELLO_PLANNING_BOARD_ID", default=""
    )
    google_calendar_email: str = Field(
        validation_alias="GOOGLE_CALENDAR_EMAIL", default=""
    )
