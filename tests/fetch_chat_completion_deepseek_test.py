...
def test_fetch_chat_completion_deepseek_returns_text() -> None:
    result = fetch_chat_completion_deepseek("Say 'Hello, world!' and nothing else.")

    assert result.text == "Hello, world!"


def test_fetch_chat_completion_deepseek_returns_cost() -> None:
    result = fetch_chat_completion_deepseek("Say 'Hello, world!' and nothing else.")
